          ...
          SizedBox(
            ...
            child: Row(
              children: [
                ...
                SizedBox(width: 3),
                Text('${movie.voteAverage.toStringAsFixed(1)}', style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                  fontWeight: FontWeight.bold
                )),
                Spacer(),
                Text(HumanFormats.number(movie.popularity), style: Theme.of(context).textTheme.bodyMedium,)
              ],
            ),
          )
